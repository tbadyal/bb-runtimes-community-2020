...
--  This file provides register definitions for the SAM3X (ARM Cortex M3)
--  microcontrollers from Atmel. Definitions are taken from 'SAM3X Series'
--  datasheet (document Atmel-11057C-ATARM-SAM3X-SAM3A-Datasheet_23-Mar-15).

package System.SAM3X is
   pragma No_Elaboration_Code_All;
   --  Allow user code with pragma No_Elaboration_Code_All to use this package

   pragma Preelaborate (System.SAM3X);
